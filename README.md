...
- a power on switch
- a button to enter into the Setup Portal Mode
...
When the ARR is started for the first time or whenever you want to reset to the factory settings, keep the button pressed for more than 15 seconds during power on:
